...
CREATE TABLE GOPY (
   ...
   FLAGTANGQUA			BIT					 NULL,
   FLAGXACNHANXOA		BIT					NULL,
...
INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (5, 6, 3, N'HANG RAT TOT, DANG TIEN', '2017-12-13 3:14:35', 0, '2018-12-27 3:19:17',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (12, 6, 4, N'ASDASDSAD', '2017-9-1 5:19:21', 0, '2018-12-29 5:5:15',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (19, 2, 2, N'siêuuu NGON luôn nha😊', '2017-2-2 6:23:39', 1, '2018-5-13 7:51:48',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (11, 3, 9, N'xinh lắm luônn >< giao hàng hơi lâu:(( nhưng vẫn 5*', '2017-3-26 1:32:41', 0, '2018-2-19 0:32:52',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (17, 7, 4, N'nhà bán hàng giao cho người vận chuyển rất lâu, tầm 1 tuần mới có hàng. Tôi phải ib shop để xử lý đơn hàng cho tôi. Cơ mà khi tôi ib thì shop trả lời rất lịch sự, tôi khá thích về sự lịch sự của shop. Còn về chất lượng sản phẩm thì ok, dùng rất thích.', '2017-11-10 4:28:24', 1, '2018-1-1 0:0:0',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (4, 4, 0, N'quá tệ, hàng không giống như trên quảng cáo, quá tệ', '2017-1-29 3:44:28', 1, '2018-2-12 7:1:5',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (13, 6, 6, N'rất đẹp như mong đợi 😍😍', '2017-12-29 4:58:15', 1, '2018-11-9 2:50:8',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (6, 4, 6, N'Hàng cực kì, cực kì tốt luôn😗. Với lại còn dễ thương, mà còn giao hàng nhanh nữa. Mọi người hãy tin tưởng và mua hàng ở Shop này nhé.💙', '2017-1-1 0:0:0', 1, '2018-6-30 5:50:23',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (0, 7, 6, N'sản phẩm giống như hình, đẹp😊nhưng có điều là shop nên cho chọn màu thì mình sẽ thích hơn là màu ngẫu nhiên 😉', '2017-5-9 2:35:43', 1, '2018-1-11 2:35:24',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (16, 6, 2, N'ahhahahahhhha', '2017-4-17 6:6:45', 1, '2018-3-18 4:13:14',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (7, 3, 4, N'ship hàng nhanh, date lâu hơn trên order. đóng gói chưa tốt lắm, thùng bị móp méo và ko chắc chắn, may ko ảnh hưởng đến chất lượng', '2017-2-12 0:32:12', 1, '2018-2-14 1:27:39',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (8, 4, 7, N'ngon tuyệt . Các cháu nhỏ rất thích .,', '2017-1-19 1:58:58', 0, '2018-2-9 6:30:39',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (9, 4, 9, N'Hang kem chat luong. ko sử dụng được', '2017-8-4 7:37:27', 1, '2018-6-14 1:59:2',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (15, 1, 3, N'minh không thích sản phẩm này. dùng tạm ', '2017-12-3 6:54:3', 1, '2018-3-23 7:18:46',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (1, 1, 5, N'rất thích hàng của shop', '2017-8-18 4:1:29', 1, '2018-6-22 1:1:6',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (2, 2, 4, N'đã mua nhiều lần, cực kỳ yên tâm ', '2017-5-30 7:15:29', 1, '2018-7-30 6:5:4',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (18, 0, 3, N'chat luong tot. se mua nua', '2017-6-3 4:43:30', 0, '2018-4-2 5:31:43',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (3, 5, 4, N'Hang tot ', '2017-6-7 7:58:40',0, '2018-6-7 3:35:43',0,0)
GO


INSERT INTO GOPY (MAGOPY, MAHANG, MAKH, NOIDUNG, NGAYGOPY, FLAGXAU, NGAYCHINHSUARECORD,FLAGTANGQUA,FLAGXACNHANXOA) VALUES (10, 5, 9, N'Hang kem chat luong. khong giong hinh', '2017-8-16 0:56:43', 1, '2018-8-1 4:28:15',0,0)
GO
...
INSERT INTO CHITIETBANGTHONGKE (MABANGTHONGKE, MAGOPY) VALUES (0, 1)
GO


INSERT INTO CHITIETBANGTHONGKE (MABANGTHONGKE, MAGOPY) VALUES (0, 2)
GO

INSERT INTO CHITIETBANGTHONGKE (MABANGTHONGKE, MAGOPY) VALUES (0, 3)
GO

INSERT INTO CHITIETBANGTHONGKE (MABANGTHONGKE, MAGOPY) VALUES (0, 5)
GO
...
INSERT INTO DONNHAPHANG (MADONNHAP, MANV, MANCC, TONGLUONGHANG, LYDONHAP, NGAYNHAP, TRANGTHAIXACNHAN) VALUES (3, 4, 0, 18, N'thiếu hàng trầm trọng', '2019-1-1 0:0:0', 3)
GO


INSERT INTO DONNHAPHANG (MADONNHAP, MANV, MANCC, TONGLUONGHANG, LYDONHAP, NGAYNHAP, TRANGTHAIXACNHAN) VALUES (4, 7, 1, 11, N'nhu cầu tăng đột biến', '2019-8-29 8:3:31', 2)
GO


INSERT INTO DONNHAPHANG (MADONNHAP, MANV, MANCC, TONGLUONGHANG, LYDONHAP, NGAYNHAP, TRANGTHAIXACNHAN) VALUES (1, 4, 1, 1, N'nhập hàng định kỳ', '2019-5-4 2:3:28', 0)
GO
...
INSERT INTO DONNHAPHANG (MADONNHAP, MANV, MANCC, TONGLUONGHANG, LYDONHAP, NGAYNHAP, TRANGTHAIXACNHAN) VALUES (2, 4, 2, 11, N'thử nghiệm sản phẩm mới', '2019-9-15 6:19:58', 4)
GO
SET IDENTITY_INSERT DONNHAPHANG  OFF;
...
SELECT c.MAGOPY, g.MAHANG, g.NOIDUNG, g.NGAYGOPY FROM BANGTHONGKEGOPY b, CHITIETBANGTHONGKE c, GOPY g WHERE b.MABANGTHONGKE=c.MABANGTHONGKE AND c.MAGOPY=g.MAGOPY AND g.FLAGXAU=1 AND b.MABANGTHONGKE=0

INSERT into donnhaphang(manv, mancc, tongluonghang, lydonhap, ngaynhap, trangthaixacnhan) output INSERTED.madonnhap values (4,0,10,'h',GETDATE(),0)
